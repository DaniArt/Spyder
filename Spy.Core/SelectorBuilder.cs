...
public static class SelectorBuilder
{
    public static string Build(SpyElement element)
    {
        ...
        else
        {
             ...
             BuildWin32MsaaFallback(element, parts, isColvir);
        }
    ...
    static void BuildWin32MsaaFallback(SpyElement element, List<string> parts, bool isColvir)
    {
        // Для Colvir: Sys.Process("COLVIR").Form("...").VCLObject("...")
        // Для прочих Win32: Sys.Process("...").Form("...").Client("...")
